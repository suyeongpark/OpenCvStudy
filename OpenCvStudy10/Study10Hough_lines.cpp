#include "pch.h"
#include "Study10Hough_lines.h"


Study10Hough_lines::Study10Hough_lines()
{
}
...
int Study10Hough_lines::Start()
{
	string path = "D:\\Dev\\Study\\Open CV 영상처리_학습자용\\교재예제\\10장_예제\\image\\";
	Mat image = imread(path + "hough_test.jpg", 0);
...
void Study10Hough_lines::hough_coord(Mat image, Mat& acc_mat, double rho, double theta)
{
...
void Study10Hough_lines::acc_mask(Mat acc_mat, Mat& acc_dst, Size size, int thresh)
{
...
void Study10Hough_lines::thres_lines(Mat acc_dst, Mat& lines, double _rho, double theta, int thresh)
{
...
void Study10Hough_lines::sort_lines(Mat lines, vector<Vec2f>& s_lines)
{
...
void Study10Hough_lines::houghLines(Mat src, vector<Vec2f>& s_lines, double rho, double theta, int thresh)
{
...
void Study10Hough_lines::draw_houghLines(Mat src, Mat & dst, vector<Vec2f> lines, int nline)
{
