...
Study8PerpectiveTransform::Study8PerpectiveTransform()
{
}
...
int Study8PerpectiveTransform::Start()
{
	string path = "D:\\Dev\\Study\\Open CV 영상처리_학습자용\\교재예제\\08장_예제\\08장_5~7절\\image\\";
	Mat image = imread(path + "perspective_test.jpg", IMREAD_COLOR);
	...
	cout << "[perpect_map] = " << endl << perspect_map << endl;
