#include "pch.h"
#include "StudyCameraFrame.h"
#include <opencv2/opencv.hpp>
using namespace cv;
using namespace std;


StudyCameraFrame::StudyCameraFrame()
{
}
...
int StudyCameraFrame::Start()
{
	...
	VideoWriter writer;
	writer.open("D:\\Dev\\Study\\Open CV 영상처리_학습자용\\교재예제\\04장_예제\\04장_5~6절\\image\\video_file2.avi", fourcc, fps, size);
